...
const AboutPage = () => {
  ...
  const milestones = [
    ...
    { year: '2019', title: 'First 1000', description: '1000+ students successfully trained across various programs' },
    { year: '2020', title: 'Digital Pivot', description: 'Adapted to digital learning during pandemic, reaching 2000+ students' },
    { year: '2021', title: 'Corporate Expansion', description: 'Expanded to corporate training with 15+ industry partners' },
    { year: '2022', title: 'National Reach', description: 'Established presence in 8 major cities across India' },
    { year: '2023', title: 'ESG Focus', description: 'Launched comprehensive ESG and sustainability programs' },
    { year: '2024', title: 'Innovation Hub', description: '4500+ students trained, 30+ corporate clients, 20+ institution partnerships' },
  ];
    ...
    <div className="min-h-screen pt-16">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <motion.p
            className="text-xl text-darkCyanGreen/80 max-w-4xl mx-auto leading-relaxed"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
...
With 350+ experts, 170+ clients, and collaborations with 35+ institutions, INNOVEITY is shaping a global learning ecosystem that equips the next generation with skills inspired by the world’s leading companies.
